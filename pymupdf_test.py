...
def extract_pdf_with_data(pdf_path, output_folder=None):
    ...
    Args:
        ...
        output_folder (str, optional): 輸出資料夾路徑
...
# 簡單的文本提取版本
def extract_plain_text(pdf_path, output_txt_path=None):
    """
    簡單地提取所有文字到單一文本文件
    
    Args:
        pdf_path: PDF檔案路徑
        output_txt_path: 輸出文字檔路徑
...
if __name__ == "__main__":
    ...
    output_folder = "extracted_pdf_content1"
    ...
    # 選項2: 僅提取純文字
    # text = extract_plain_text(pdf_file, os.path.join(output_folder, "simple_text.txt"))
    # print(f"已提取 {len(text)} 個字元")